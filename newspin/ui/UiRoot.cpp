...
//pwdView->setColumnHidden(1,true);
  ...
  historyModel->setHeaderData(1, Qt::Horizontal,tr("历史日期"));
  historyModel->setHeaderData(2,Qt::Horizontal, tr("所属用户"));
  historyModel->setHeaderData(3,Qt::Horizontal, tr("膜泵"));
  historyModel->setHeaderData(4,Qt::Horizontal, tr("芯泵"));
  historyModel->setHeaderData(5,Qt::Horizontal, tr("膜温"));
  historyModel->setHeaderData(6,Qt::Horizontal, tr("芯温"));
  historyModel->setHeaderData(7,Qt::Horizontal, tr("水槽温1"));
  historyModel->setHeaderData(8,Qt::Horizontal, tr("空气间隙"));
  historyModel->setHeaderData(9,Qt::Horizontal, tr("DMAC"));
  historyModel->setHeaderData(10,Qt::Horizontal, tr("导丝速度1"));
  historyModel->setHeaderData(11,Qt::Horizontal, tr("导丝升降1"));
  historyModel->setHeaderData(12,Qt::Horizontal, tr("循环泵1"));
  historyModel->setHeaderData(13,Qt::Horizontal, tr("补液泵"));
  historyModel->setHeaderData(14,Qt::Horizontal, tr("水槽温2"));
  historyModel->setHeaderData(15,Qt::Horizontal, tr("导丝速度2"));
  historyModel->setHeaderData(16,Qt::Horizontal, tr("导丝升降2"));
  historyModel->setHeaderData(17,Qt::Horizontal, tr("循环泵2"));
  historyModel->setHeaderData(18,Qt::Horizontal, tr("水槽温3"));
  historyModel->setHeaderData(19,Qt::Horizontal, tr("收丝速度2"));
  historyModel->setHeaderData(20,Qt::Horizontal, tr("收丝升降2"));
  historyModel->setHeaderData(21,Qt::Horizontal, tr("循环泵3"));
  historyModel->select();

  historyView = new QTableView(this);
  historyView->setModel(historyModel);
  historyView->setColumnHidden(0,true);
...
//  deleteHistoryBt=new QPushButton(tr("删除历史"),this);
  ...
  deleteUserBt->setGeometry(400,40,120,60);
  ...
  if(event->button() & Qt::LeftButton)
    {
      ...
      else if(QRect(900,0,40,40).contains(event->pos()))
        {
          emit ChangeUi(1);
        }
      update();
