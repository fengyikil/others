  ...
  : QWidget(parent)
{
  ...
  mapRect.insert("0",QRect(5,185,130,35));
...
void SoftKey::paintEvent(QPaintEvent *)
{
...
void SoftKey::hideEvent(QHideEvent *)
{
  text.clear();
  inputState = 0;
  clickIndex="";
...
void SoftKey::ShowMove(QPoint p)
{
  nowSet = qobject_cast<KeySet*>(sender());
  this->hide();
  this->move(p);
  this->show();
}
